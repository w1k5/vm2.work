...
<img alt="Mobile home page" src="{{ "/_screenshots/2.png?raw=true" width="300px" | relative_url }} />
<img alt="Mobile post page" src="{{ "/_screenshots/3.png?raw=true" width="300px" | relative_url }} />
