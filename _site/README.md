...
<img alt="Mobile home page" src="{{ site.url }}/_screenshots/2.png?raw=true" width="300px" />
<img alt="Mobile post page" src="{{ site.url }}/_screenshots/3.png?raw=true" width="300px" />
